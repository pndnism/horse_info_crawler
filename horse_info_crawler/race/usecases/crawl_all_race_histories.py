...
class CrawlRaceHistoriesUsecase:
    ...
    def exec(self, crawl_limit: Optional[int] = None):
        ...
        self.race_info_repository.save_raw_properties(race_histories)
        self.race_info_repository.save_shaped_properties(self._shape_properties(race_histories))
        logger.info("End crawl_race_histories.")

    def _crawl_race_histories(self, crawl_limit: Optional[int] = None) -> List[ShapedRaceData]:
        race_histories = []
